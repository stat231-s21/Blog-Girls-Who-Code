...
ggplot(alL_vars_data, aes(x = clust4, fill = GENDER2)) +
  ...
  labs(title = "Distribution of Cluster Assignment by Gender", 
       x = "Cluster Assignment", 
       fill = "Gender") 

ggplot(alL_vars_data, aes(x = clust4, fill = RACETH2)) +
  geom_histogram(stat = "count") +
  labs(title = "Distribution of Cluster Assignment by Race", 
       x = "Cluster Assignment", 
       fill = "Race")

ggplot(alL_vars_data, aes(x = clust4, fill = P_DENSE2)) +
  geom_histogram(stat = "count") +
  labs(title = "Distribution of Cluster Assignment by Population Density", 
       x = "Cluster Assignment", 
...
ggplot(alL_vars_data, aes(x = clust4, fill = ECON6A_2)) +
  geom_histogram(stat = "count") +
  labs(title = "Distribution of Cluster Assignment by Unemployment Insurance Status", 
       x = "Cluster Assignment", 
       fill = "Unemployment Insurance Status")

ggplot(alL_vars_data, aes(x = clust4, fill = ECON6C_2)) +
  geom_histogram(stat = "count") +
  labs(title = "Distribution of Cluster Assignment by TANF Status", 
       x = "Cluster Assignment", 
       fill = "TANF Status")

ggplot(alL_vars_data, aes(x = clust4, fill = ECON5A_B2)) +
  geom_histogram(stat = "count") +
  labs(title = "Distribution of Cluster Assignment by Level of Food Security", 
       x = "Cluster Assignment", 
