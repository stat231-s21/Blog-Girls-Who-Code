...
The plot below shows the proportion of responses to the TANF status question.
...
```{r, results='asis'}
knitr::kable(TANF_data, "latex", booktabs = TRUE, escape = FALSE, 
             col.names = c("Cluster Assignmnet", 
                           "Applied", 
                           "Did Not Apply", 
                           "Recieved", 
                           "Tried to Appy"))%>% 
